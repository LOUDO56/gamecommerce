    ...
    <header className='fixed w-full z-10'>
        <nav className="flex items-center justify-between gap-3 w-full py-5 px-4 bg-orange-500 text-white">
            ...
            <form className='flex items-center'>
                <Input type='search' defaultValue={defaultSearch} placeholder='Outer Wilds...' className='bg-white w-full sm:w-[400px] md:w-[700px] border-none rounded-r-none text-black' onChange={(e) => handleChange(e.currentTarget.value)} />
